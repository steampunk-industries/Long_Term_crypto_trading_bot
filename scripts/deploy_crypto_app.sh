#!/bin/bash
# Direct AWS CloudFormation deployment script for crypto trading bot
...
echo -e "${BLUE}==================================================${NC}"
echo -e "${GREEN}DIRECT AWS DEPLOYMENT FOR CRYPTO TRADING BOT${NC}"
echo -e "${BLUE}==================================================${NC}"
...
aws cloudformation validate-template --template-body file://aws-cloudformation-enhanced.yml
